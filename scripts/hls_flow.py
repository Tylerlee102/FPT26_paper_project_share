...
TCL_BY_STEP = {
    ...
    "rs2-fold-write-partial-banks-csim": Path(
        "hls/rs2/tcl/run_fold_write_partial_banks_csim.tcl"
    ),
    "rs2-fold-write-partial-banks-csynth": Path(
        "hls/rs2/tcl/run_fold_write_partial_banks_csynth.tcl"
    ),
    "rs2-snapshot-write-partial-banks-csim": Path(
        "hls/rs2/tcl/run_snapshot_write_partial_banks_csim.tcl"
    ),
    "rs2-snapshot-write-partial-banks-csynth": Path(
        "hls/rs2/tcl/run_snapshot_write_partial_banks_csynth.tcl"
    ),
    "rs2-split-fold-write-csim": Path(
        "hls/rs2/tcl/run_split_fold_write_csim.tcl"
    ),
    ...
    "rs2-fold-write-contiguous-banks-csim": Path(
        "hls/rs2/tcl/run_fold_write_contiguous_banks_csim.tcl"
    ),
    "rs2-fold-write-contiguous-banks-csynth": Path(
        "hls/rs2/tcl/run_fold_write_contiguous_banks_csynth.tcl"
    ),
    "rs2-snapshot-write-contiguous-banks-csim": Path(
        "hls/rs2/tcl/run_snapshot_write_contiguous_banks_csim.tcl"
    ),
    "rs2-snapshot-write-contiguous-banks-csynth": Path(
        "hls/rs2/tcl/run_snapshot_write_contiguous_banks_csynth.tcl"
    ),
    ...
    "rs2-partial-layer-banks-csim": Path(
        "hls/rs2/tcl/run_partial_layer_banks_csim.tcl"
    ),
    "rs2-partial-layer-banks-csynth": Path(
        "hls/rs2/tcl/run_partial_layer_banks_csynth.tcl"
    ),
