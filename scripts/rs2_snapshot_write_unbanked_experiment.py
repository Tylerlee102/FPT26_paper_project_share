"""Generate an unbanked RS2 fold-write variant with localized snapshot writes."""
...
def generate(output: Path, manifest_path: Path) -> dict[str, object]:
    ...
    manifest = {
        ...
        "behavioral_contract": (
            ...
            "and unbanked resident state; only LOAD resident-write hierarchy changes"
        ),
