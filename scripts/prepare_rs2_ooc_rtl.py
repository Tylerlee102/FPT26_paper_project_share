...
DEFAULT_SOURCE = (
    ROOT / "gdn_rs2_hls" / "u55c_250mhz" / "syn" / "verilog" / "gdn_rs2_top.v"
)
DEFAULT_OUTPUT = ROOT / "build" / "vivado" / "rs2_ooc_rtl" / "gdn_rs2_top.v"
...
def transform_top(source: str) -> str:
    ...
    if "module gdn_rs2_top (" not in source:
        raise ValueError("expected gdn_rs2_top module")
