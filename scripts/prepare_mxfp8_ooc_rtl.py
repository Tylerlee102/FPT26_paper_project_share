"""Generate an MXFP8 OOC top whose kernel clock is buffered before RTL synthesis."""
...
DEFAULT_SOURCE = (
    ROOT / "gdn_mxfp8_hls" / "u55c_250mhz" / "syn" / "verilog" / "gdn_mxfp8_top.v"
)
DEFAULT_OUTPUT = ROOT / "build" / "vivado" / "mxfp8_ooc_rtl" / "gdn_mxfp8_top.v"
...
def transform_top(source: str) -> str:
    ...
    if "module gdn_mxfp8_top (" not in source:
        raise ValueError("expected gdn_mxfp8_top module")
