...
set report_dir [file normalize "reports/vivado/baselines/mxfp8/postroute_sweep"]
set checkpoint [file normalize "build/vivado/gdn_mxfp8_vivado/mxfp8_post_impl.dcp"]
file mkdir $report_dir

if {![file isfile $checkpoint]} {
  error "Missing native-MXFP8 routed checkpoint: $checkpoint"
}

open_checkpoint $checkpoint
set first_passing_period ""

foreach period_ns {4.000 5.000 6.000 6.250 6.500 7.000 8.000} {
...
if {$first_passing_period eq ""} {
  error "MXFP8 fixed-route sweep contains no passing setup point"
}
