...
set project_dir [file normalize "build/vivado/gdn_rs2_snapshot_write_contiguous_banks_vivado"]
set rtl_dir [file normalize "gdn_rs2_snapshot_write_contiguous_banks_hls/u55c_250mhz/syn/verilog"]
set ooc_top_file [file normalize "build/vivado/rs2_snapshot_write_contiguous_banks_ooc_rtl/gdn_rs2_top.v"]
...
if {![file isdirectory $rtl_dir]} {
  error "Missing snapshot-write contiguous-bank RS2 HLS RTL directory: $rtl_dir"
}
if {![file isfile $ooc_top_file]} {
  error "Missing snapshot-write contiguous-bank generated OOC top: $ooc_top_file"
}

create_project -force gdn_rs2_snapshot_write_contiguous_banks_vivado $project_dir -part xcu55c-fsvh2892-2L-e
set_property target_language Verilog [current_project]
set_property source_mgmt_mode None [current_project]

set generated_rtl_files [glob -nocomplain -directory $rtl_dir *.v]
if {[llength $generated_rtl_files] == 0} {
  error "No snapshot-write contiguous-bank RS2 Verilog files found in $rtl_dir"
}
