...
set output_checkpoint [file normalize "build/vivado/gdn_rs2_vivado/rs2_post_impl_fanout_opt.dcp"]
set report_dir [file normalize "reports/vivado/corrected/rs2_current/postroute_fanout_opt"]
