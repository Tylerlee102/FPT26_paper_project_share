...
set project_dir [file normalize "build/vivado/gdn_mxfp8_vivado"]
set rtl_dir [file normalize "gdn_mxfp8_hls/u55c_250mhz/syn/verilog"]
set ooc_top_file [file normalize "build/vivado/mxfp8_ooc_rtl/gdn_mxfp8_top.v"]
set xdc_file [file normalize "vivado/constraints/timing.xdc"]
set ooc_xdc_file [file normalize "vivado/constraints/mxfp8_ooc.xdc"]

if {![file isdirectory $rtl_dir]} {
  error "Missing MXFP8 HLS RTL directory: $rtl_dir"
}
if {![file isfile $ooc_top_file]} {
  error "Missing generated MXFP8 OOC top: $ooc_top_file"
}

create_project -force gdn_mxfp8_vivado $project_dir -part xcu55c-fsvh2892-2L-e
set_property target_language Verilog [current_project]
set_property source_mgmt_mode None [current_project]

set generated_rtl_files [glob -nocomplain -directory $rtl_dir *.v]
if {[llength $generated_rtl_files] == 0} {
  error "No MXFP8 Verilog files found in $rtl_dir"
}

set support_rtl_files {}
foreach rtl_file $generated_rtl_files {
  if {[file tail $rtl_file] ne "gdn_mxfp8_top.v"} {
...
set_property top gdn_mxfp8_top [current_fileset]
