...
set report_dir [file normalize "reports/vivado/baselines/mxfp8"]
set checkpoint_dir [file normalize "build/vivado/gdn_mxfp8_vivado"]
set synth_checkpoint [file join $checkpoint_dir mxfp8_post_synth.dcp]
...
if {[file exists $synth_checkpoint]} {
  ...
  source vivado/tcl/create_mxfp8_project.tcl
  synth_design -top gdn_mxfp8_top -part xcu55c-fsvh2892-2L-e -mode out_of_context
  write_checkpoint -force $synth_checkpoint
}

if {[llength [get_cells -quiet ooc_ap_clk_bufg]] != 1} {
  error "Synthesized checkpoint does not contain the generated MXFP8 OOC BUFGCE"
}
...
write_checkpoint -force [file join $checkpoint_dir mxfp8_post_impl.dcp]
exit
