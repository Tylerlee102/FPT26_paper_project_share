...
set report_dir [file normalize "reports/vivado/corrected/rs2_current/postroute_sweep"]
...
foreach period_ns {4.000 5.000 6.000 6.500 7.000 7.500 8.000 9.000} {
...
if {$first_passing_period eq ""} {
  error "RS2 fixed-route sweep contains no passing setup point"
}
