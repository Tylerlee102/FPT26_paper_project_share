set report_dir [file normalize "reports/vivado/experiments/rs2_fold_write_address_fanout16_20260810"]
set checkpoint_dir [file normalize "build/vivado/gdn_rs2_fold_write_address_fanout16_vivado"]
set synth_checkpoint [file join $checkpoint_dir rs2_fold_write_address_fanout16_post_synth.dcp]
file mkdir $report_dir
file mkdir $checkpoint_dir

source vivado/tcl/create_rs2_fold_write_address_fanout_project.tcl
...
write_checkpoint -force [file join $checkpoint_dir rs2_fold_write_address_fanout16_post_impl.dcp]
exit
