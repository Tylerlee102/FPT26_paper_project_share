...
set synth_checkpoint [file join $checkpoint_dir bf16_post_synth.dcp]
...
if {[llength [get_cells -quiet ooc_ap_clk_bufg]] != 1} {
  error "Synthesized checkpoint does not contain the generated BF16 OOC BUFGCE"
}
...
write_checkpoint -force [file join $checkpoint_dir bf16_post_impl.dcp]
exit
