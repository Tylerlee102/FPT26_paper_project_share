...
- Bounded 250 MHz repair attempts: `aggressive_fanout` WNS `-1.656` ns, `retiming` WNS `-1.656` ns, `slr_crossing` WNS `-1.736` ns, `explore` WNS `-1.690` ns, `aggressive_explore` WNS `-1.690` ns, `fanout_then_aggressive` WNS `-1.655` ns
