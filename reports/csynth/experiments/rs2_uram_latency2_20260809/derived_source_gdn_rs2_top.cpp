...
#pragma HLS BIND_STORAGE variable=resident_primary type=ram_t2p impl=uram latency=2
#pragma HLS BIND_STORAGE variable=resident_residual type=ram_t2p impl=uram latency=2
...
#pragma HLS BIND_STORAGE variable=resident_keys type=ram_t2p impl=uram latency=2
#pragma HLS BIND_STORAGE variable=resident_updates type=ram_t2p impl=uram latency=2
