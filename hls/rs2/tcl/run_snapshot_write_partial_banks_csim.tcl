open_project -reset gdn_rs2_snapshot_write_partial_banks_trace_hls
set_top gdn_rs2_top
set config_cflags "-Ihls/include -Ihls/rs2/include -std=c++14"
add_files -cflags $config_cflags hls/rs2/src/rs2_arithmetic.cpp
add_files -cflags $config_cflags build/experiments/rs2_snapshot_write_partial_banks/gdn_rs2_top.cpp
