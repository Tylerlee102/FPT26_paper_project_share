...
enum CounterIndex : int {
  ...
  COUNTER_E2M0_RESIDUAL_CLIPS = 5,
  COUNTER_FOLDS = 6,
  COUNTER_COMMITTED_GENERATIONS = 7,
  COUNTER_COUNT = 8,
};
...
using state_residual_elements_t =
    e2m0_t[gdn::NUM_VALUE_HEADS][gdn::KEY_DIM][gdn::VALUE_DIM];
...
using state_residual_word_t = ap_uint<3 * gdn::BLOCK_SIZE>;
